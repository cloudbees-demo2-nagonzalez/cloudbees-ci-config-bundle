...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/cloudbees-demo2-nagonzalez/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>cloudbees-demo2-nagonzalez</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>cloudbees-demo2-nagonzalez</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/cloudbees-demo2-nagonzalez/pipeline-template-catalog.git</repositoryUrl>
              <traits>
